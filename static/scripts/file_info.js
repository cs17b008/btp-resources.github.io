...
function file_info() {
    ...
    */
    ...
    this.GetDirName = function () {
        console.log("\n************\n");
        console.log("FILE-INFO.JS CHECK\n");
        console.log(this.dir_name + '_' + username);
        console.log("\n************\n");
    ...
    this.FetchImage = function () {
        var url = '/static/perl/fetch_image.cgi?mode=' + this.mode + '&username=' + username + '&collection=' + this.collection.toLowerCase() + '&folder=' + this.dir_name + '&image=' + this.im_name;
        var im_req;
